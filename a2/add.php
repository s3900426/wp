...
<main class="container col-12">
    <h1 class="p-10">Add New Skill</h1>
    <form method="post" action="process_add.php" class="form-control" enctype="multipart/form-data" id="skillForm">
        <div class="mb-3">
            <label for="title" class="form-label">Title <span class="orangeAsterisk">*</span></label>
            <input class="form-control" type="text" id="title" name="title" placeholder="Enter skill title" required>
        </div>
        <div class="mb-3">
            <label for="description" class="form-label">Description <span class="orangeAsterisk">*</span></label>
            <textarea class="form-control" rows="8" id="description" name="description" placeholder="Enter Description"
                required></textarea>
        </div>
        <div class="mb-3">
            <label for="category" class="form-label">Category <span class="orangeAsterisk">*</span></label>
            <input class="form-control" type="text" id="category" name="category" placeholder="Enter skill category"
                required>
        </div>
        <div class="mb-3">
